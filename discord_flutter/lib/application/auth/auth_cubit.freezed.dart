...
mixin _$AuthState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoggedIn, userId);

  @override
  String toString() {
    return 'AuthState(isLoggedIn: $isLoggedIn, userId: $userId)';
  }
}
...
abstract mixin class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoggedIn, int userId});
}
...
class _AuthState implements AuthState {
  _AuthState({required this.isLoggedIn, required this.userId});
