...
CREATE TABLE "discord_channel" (
    ...
    "name" text NOT NULL,
    "icon" text NOT NULL,
    "_serverDataChannelServerDataId" bigint
);
...
CREATE TABLE "message" (
    ...
    "_discordChannelMessagesDiscordChannelId" bigint
);

--
-- Class ServerData as table server_data
--
...
--
-- Foreign relations for "server_data" table
--
