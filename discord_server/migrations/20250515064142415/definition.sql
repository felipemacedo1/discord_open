...
--
-- Class DiscordChannel as table discord_channel
--
...
--
-- Class DiscordServer as table discord_server
--
...
--
-- Class DiscordUser as table discord_user
--
...
--
-- Class ServerMembership as table server_membership
--
...
--
-- Foreign relations for "discord_channel" table
--
...
--
-- Foreign relations for "discord_server" table
--
...
--
-- Foreign relations for "discord_user" table
--
...
--
-- Foreign relations for "group" table
--
...
--
-- Foreign relations for "server_membership" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('discord', '20250515064142415', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250515064142415', "timestamp" = now();
